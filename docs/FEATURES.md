...
- **Completed Rust gameplay migration** - the C# gameplay tree, test project, and Unity-only dependency plugins are removed. Component contracts are covered by the source audit, while deterministic 100x100 startup, active-flow, and post-starter-power runs prove the integrated systems at v2 scale. See [unity-feature-audit.md](unity-feature-audit.md), [v2-world.md](v2-world.md), and [v2-liveness.md](v2-liveness.md).
...
- **Sustained v2 operation** - a deterministic two-replay, 650-tick release proof advances the full 100x100 world past its first drained deployed-source battery. Remote extraction, freight, upper-tier production, coal delivery, and generator output continue while structural bounds guard dispatch, routes, claims, mutations, and power lines. See [v2-liveness.md](v2-liveness.md).
