...
- **C# decommission gates** - deterministic Rust tests and player-visible viewer state now prove the first removable C# batch: legacy pathfinding, movement, deployment, and their direct truck wiring. See [csharp-decommission.md](csharp-decommission.md).
