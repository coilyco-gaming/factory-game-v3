...
- **Local runtime factory art** - fifteen accepted 100px RGBA sprites live under `crates/factory_shell/assets/factory/` in ordinary Git. A typed Bevy resource overlays them on matching terrain, logistics, deposit, machine, structure, and cargo identities while retaining colored fallbacks, interpolation, labels, gauges, route effects, and overview performance. See [factory-art.md](factory-art.md).
