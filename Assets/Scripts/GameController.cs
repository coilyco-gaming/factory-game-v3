...
public class GameController : MonoBehaviour
{
    ...
    public Dictionary<System.Numerics.Vector2, Dictionary<string, WorldObject>> GetWorldObjects()
    {
    ...
    protected void Delete(DeletionQueueItem deletionQueueItem)
    {
        ...
        // Delete the thing
        Destroy(worldObject.gameObject);
        this.worldObjects[deletionQueueItem.position].Remove(deletionQueueItem.worldObject.Guid);
